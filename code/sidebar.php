                            ...
                            <div class="tab-pane active" id="side-tab-menu">
                                ...
                                <nav id="primary-nav">
                                    <ul>
										...
										<li>
                                            <a href="viewgtype_details.php" class="menu-link"><i class="glyphicon-fire"></i>GalleryType Details</a>
                                         </li>
                                      
                                        <li>
                                            <a href="artist_details_view.php" class="menu-link"><i class="glyphicon-vector_path_curve"></i>Artist Details</a>
                                           
                                        </li>
			
                                        <li>
                                            <a href="viewgallery_details.php" class="menu-link"><i class="glyphicon-more_windows"></i>Gallery Details</a>
                                            
                                        </li>
                                     
									 <li>
                                            <a href="viewuserdetails.php" class="menu-link"><i class="glyphicon-fire"></i>User Details</a>
                                      </li>  
									  
									  
									  <li>
                                            <a href="gallary_rating_view.php" class="menu-link"><i class="glyphicon-fire"></i> Gallary Rating Details</a>
                                      </li>  
									  <li>
                                            <a href="changepassword.php" class="menu-link"><i class="glyphicon-fire"></i>Change Password</a>
                                      </li> 
									   <li>
