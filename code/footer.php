            ...
            <footer>
                <div class="pull-right">
                    Developed <i class="icon-user"></i> by <strong><a href="#" target="_blank">Anita Warad</a></strong>
                </div>
                <div class="pull-left">
                    <span id="year-copy"></span> &copy; <strong><a href="#" target="_blank">Modern Art Wing</a></strong>
                </div>
            </footer>
            <!-- END Footer -->
        </div>
