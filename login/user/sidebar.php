                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="side-tab-menu">
                                ...
                                <nav id="primary-nav">
                                    <ul>
                                        <li>
                                            <a href="home.php"><i class="glyphicon-display"></i>Home</a>
                                        </li>
										<li>
                                            <a href="artist_info_view.php" class="menu-link"><i class="glyphicon-fire"></i>Artist Info</a>
                                         </li>
                                      
                                        <li>
                                            <a href="bank_view.php" class="menu-link"><i class="glyphicon-vector_path_curve"></i>Bank</a>
                                           
                                        </li>
			
                                        <li>
                                            <a href="bill_view.php" class="menu-link"><i class="glyphicon-more_windows"></i>Bill</a>
                                            
                                        </li>
                                     
									 <li>
                                            <a href=" gallery_info_view.php" class="menu-link"><i class="glyphicon-fire"></i>Gallary Info</a>
                                      </li>  
									 
									
									  <li>
                                            <a href=" spldiscount_view.php" class="menu-link"><i class="glyphicon-fire"></i>Special Discount</a>
                                      </li>  
									    <li>
                                            <a href=" tempcart_view.php" class="menu-link"><i class="glyphicon-fire"></i>Temporary Card</a>
                                      </li> 
									  
									  <li>
                                            <a href=" userinfo_view.php" class="menu-link"><i class="glyphicon-fire"></i>User Info</a>
                                      </li>  
									  <li>
                                            <a href="change pwd.php" class="menu-link"><i class="glyphicon-fire"></i>Change Password</a>
                                      </li> 
									   
									   <li>
                                            <a href="../logout.php" class="menu-link"><i class="glyphicon-fire"></i>Logout</a>
                                      </li>         
