            ...
            <div class="block-tabs block-themed themed-border-night">
                <ul id="login-tabs" class="nav nav-tabs themed-background-deepsea" data-toggle="tabs">
                    <li class="active text-center">
                        <a href="#login-form-tab">
                            <i class="icon-user"></i> User Sign Up
                        </a>
                    </li>
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="login-form-tab">
                        ...
                        <!-- Login Form -->
                        <form action="userdetails_insert.php" method="post" id="formID" class="form-inline">
                            <div class="control-group">
                                <div class="controls">
                                    <div class="input-prepend">
                                        <span class="add-on"><i class="icon-envelope-alt"></i></span>
                                        <input type="text" id="firstname" name="firstname" class="validate[required,custom[onlyLetter]]" placeholder="First Name..">
                                    </div>
                                </div>
                            </div>
							<div class="control-group">
                                <div class="controls">
                                    <div class="input-prepend">
                                        <span class="add-on"><i class="icon-envelope-alt"></i></span>
                                        <input type="text" id="lastname" class="validate[required,custom[onlyLetter]]" name="lastname" placeholder="Last Name..">
                                    </div>
                                </div>
                            </div>
							<div class="control-group">
							...
							<div class="control-group">
                                <div class="controls">
                                    <div class="input-prepend">
                                        <span class="add-on"><i class="icon-envelope-alt"></i></span>
                                        <input type="text" id="contactno" name="contactno" class="validate[required,custom[mobile]]" placeholder="Contact No..">
                                    </div>
                                </div>
                            </div>
							<div class="control-group">
                                <div class="controls">
                                    <div class="input-prepend">
                                        <span class="add-on"><i class="icon-envelope-alt"></i></span>
                                        <input type="text" id="emailid" name="emailid" class="validate[required,custom[email]]" placeholder="Email Id..">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                <div class="controls">
                                    <div class="input-prepend">
                                        ...
                                        <input type="password" id="password" name="password"  pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required placeholder="Password..">
                                    </div>
                                </div>
                            </div>
                            <div class="control-group">
