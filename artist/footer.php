            ...
            <footer>
                <div class="pull-right">
                    Developed <i class="icon-user"></i> by <strong><a href="#" target="_blank">Subrahmanya Hegde and Prasanna Hegde</a></strong>
                </div>
                <div class="pull-left">
                    <span id="year-copy"></span> &copy; <strong><a href="#" target="_blank"> Art Gallery</a></strong>
                </div>
            </footer>
            <!-- END Footer -->
        </div>
