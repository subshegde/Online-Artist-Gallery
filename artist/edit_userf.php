...
<form name="formID" id="formID" method="post" action="edit_userin.php">
  <table width="443" border="0">
    ...
    <tr>
      ...
      <td width="255"><input name="userid" type="text" id="userid" value="<?php echo $row['uid']; ?>" class="validate[required,custom[onlyNumber]]" ></td>
    </tr>
    <tr>
      <td>first name </td>
    ...
    <tr>
      <td>user name </td>
      <td><input name="username" type="text" id="username" value="<?php echo $row['user_name']; ?>" class="validate[required,custom[onlyLetter]]"></td>
    </tr>
    <tr>
