            ...
            <footer>
                <div class="pull-right">
                    Developed <i class="icon-user"></i> by <strong><a href="#" target="_blank">Kusuma K</a></strong>
                </div>
                <div class="pull-left">
                    <span id="year-copy"></span> &copy; <strong><a href="#" target="_blank">Online Art Gallery</a></strong>
                </div>
            </footer>
            <!-- END Footer -->
        </div>
