                    ...
                    <div class="block-content">
                        ...
                        <div class="row-fluid row-items">
                            ...
                            <div class="span9">
								...
								<?php
							$sql2="select * from Gallery_Details gd,gtype_details gt,artist_details ad where gd.gallery_type_id=gt.gallery_type_id and gd.artistid=ad.aid and gd.status='new'";
