 ...
 $ratings=$row1['ratings']; ?>
	...
	<p>&nbsp;</p>
	 <div class="progress progress-striped progress-danger active">
       <div class="bar" style="width: <?php echo $ratings; ?>px"> Rating..</div>
        </div>	</td>
  </tr>
  <tr>
    <td colspan="2" align="center"><div align="center"><a href="view_more_rating.php?g_id=<?php echo $g_id; ?>" class="btn btn-warning">View More and Rating</a></div></td>
    </tr>
