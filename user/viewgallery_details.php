...
?>
							    <div class="span3">
									...
									<?php echo $gname; ?> 
										...
										<br><font color="#000000">Price:<b><?php echo $price; ?></b></font>&nbsp;&nbsp;&nbsp;Status: 
										<?php if($status=='new') { ?> <p class="btn btn-info"> <?php echo $status; ?></p><?php } else { ?><p class="btn btn-warning"> <?php echo $status; ?></p> <?php } ?>
                                    </a>
                                </div>
								<?php
								}
