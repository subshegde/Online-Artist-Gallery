            ...
            <footer>
                <div class="pull-right">
                    Developed <i class="icon-user"></i> by <strong><a href="#" target="_blank">Subrahmanya S Hegde and Prasanna K Hegde</a></strong>
                </div>
                <div class="pull-left">
                    <span id="year-copy"></span> &copy; <strong><a href="#" target="_blank"> Artist Gallery</a></strong>
                </div>
            </footer>
            <!-- END Footer -->
        </div>
