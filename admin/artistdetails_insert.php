...
awardwin=request.getParameter("awardwin");
addrs=request.getParameter("addrs");
emailid=request.getParameter("emailid");
contno=request.getParameter("contno");
username=request.getParameter("username");
int k=s.st.executeUpdate("insert into Artist_Details values(null,'"+aname+"',"+workexp+",'"+awardwin+"','"+addrs+"','"+emailid+"','"+contno+"','"+username+"')");
%> 
